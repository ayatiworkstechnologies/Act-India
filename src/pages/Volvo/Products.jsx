...
const containerVariants = {
  ...
  visible: {
    opacity: 1,
    transition: {
      staggerChildren: 0.28,      // increased from 0.18
  ...
  return (
    ...
    >
      ...
      <div className="px-5 pb-5">
        ...
        {subtitle1 && (
          <p className="text-[13px] md:text-lg font-bold text-black mt-2">
            {subtitle1}
          </p>
        )}
        {subtitle && (
          <p className="mt-2 text-[13px] md:text-[14px] text-neutral-600">
            {subtitle}
          </p>
        )}
        {link && (
          <a
            ...
            className="inline-block mt-4 px-5 py-2 bg-secondary text-white text-sm font-medium"
  ...
  return (
    ...
    >
      ...
      >
        <button
          onClick={onClose}
          className="absolute top-3 right-3 h-9 w-9 bg-black/80 text-white rounded-full z-50 text-xl leading-none"
        >
          ×
        </button>
