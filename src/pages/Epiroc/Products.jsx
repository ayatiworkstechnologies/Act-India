        ...
        <AnimatePresence mode="wait">
          ...
          >
            {active === "Supplies" ? (
              ...
              current.map((p, i) => (
                <motion.div key={`${p.title ?? "item"}-${i}`} variants={cardItem}>
...
function ProductCard({ img, title, subtitle, onClick, link }) {
  return (
    <article
      className="bg-white ring-1 ring-gray-100 shadow-[0_20px_55px_-25px_rgba(0,0,0,0.35)] overflow-hidden transition hover:shadow-[0_28px_70px_-30px_rgba(0,0,0,0.35)] cursor-pointer h-full"
      onClick={onClick}
    >
